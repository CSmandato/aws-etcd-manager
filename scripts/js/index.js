...
function main() {
  ...
  flags.defineString("tag", "aws:autoscaling:groupName", "The instance tag that is common to all members of the cluster");
  ...
  const etcdNodeManager = new EtcdNodeManager(instanceId, backupBucket, backupKey, backupInterval, dataDir);
