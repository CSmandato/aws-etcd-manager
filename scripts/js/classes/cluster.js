...
class Cluster {
    ...
    constructor({instanceId = null, tagName = null, tagValue = null, instance = null, autoScalingGroup = null, members = [], logger = null} = {}) {
    ...
    async getMembers() {
        ...
        if (tagValue == null) {
            ...
            throw new Error("Current instance " + this.instanceId + ' does not have a tag ' + tagValue);
        }
